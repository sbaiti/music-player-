...
var storage = multer.diskStorage({
    destination: (req, file, cb) => {
        cb(null, 'back-part/public/uploads')
    },
...
Router.get("/allMusicUploaded", passport.authenticate("jwt", { session: false }), (req, res) => {
...
Router.get('/musicsByName', function (req, res, next) {
    var options = {
        root: path.resolve(process.cwd() + '/back-part/public/uploads/'),
        dotfiles: 'deny',
        headers: {
